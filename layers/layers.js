...
//ol.proj.get("EPSG:3857").setExtent([8233452.415180, 2168754.383670, 8715396.505692, 2544057.474097]);
var wms_layers = [];
...
lyr_KonkanandNagpurMSEDCLPlaces_2.set('fieldLabels', {'id': 'no label', 'Place Name': 'no label', 'Type': 'no label', });
lyr_KonkanandNagpurTourRoute_3.set('fieldLabels', {'id': 'no label', 'Region': 'no label', 'From': 'no label', 'To': 'no label', });
